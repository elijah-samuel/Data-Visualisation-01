...
Due to time restraints and with permission from Professor, the data used from the Gaskell corpus has not been cleaned, and is raw data. For that reason, there might be some weird names or patterns in the visualisations.
